...
import pytest
from src.domain.fiat import FiatAnyCryptoFilter, FiatFixedCryptoFilter, FiatOrder, FiatParams
...
from tests.repository.test_repo import (  # type: ignore
    EXAMPLE_P2PRepo_FIND_FILTER_KZT,
    EXAMPLE_P2PRepo_FIND_FILTER_RUB,
    EXAMPLE_P2PRepo_FIND_RETURN_KZT,
    EXAMPLE_P2PRepo_FIND_RETURN_RUB,
)
...
class TestFiatFixedCryptoExchanger:
    ...
    async def test_find_best_price(self, p2p_exchanger_stub):
        ...
        assert result.price == (EXAMPLE_P2PRepo_FIND_RETURN_KZT.price / EXAMPLE_P2PRepo_FIND_RETURN_RUB.price)
...
class TestFiatAnyCryptoExchanger:
    ...
    async def test_find_best_price(self, fiat_exchanger_stub):
        ...
        result = await service.find_best_price(EXAMPLE_FiatAnyCryptoExchanger_FIND_FILTER)
